...
<html lang="en">
  <head>
    ...
    <link href="styling/schools.css" rel="stylesheet">
    ...
    <div class="container-fluid p-1">
        <nav id="nav" class="navbar fixed-top navbar-expand-lg navbar-light">
            <a class="navbar-brand" href="index.php">
                <img class="kumquat-header" src="imgs/kumquat_outline.png" alt="kumquat">
                KUM to the QUAT
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="schools.php">Schools Eligible</a>
                    </li>
              
                    <!-- <li class="nav-item">
                        <a class="nav-link" href="#">Find your school</a>
                    </li> -->
                </ul>
